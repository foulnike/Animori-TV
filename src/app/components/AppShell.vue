...
//
// Рельс сложен по умолчанию (248 px всегда держать незачем) и
// раскрывается под курсором или по фокусу с клавиатуры — поверх
// содержимого, а не раздвигая его; оттуда же fixed вместо sticky.
// После нажатия мышью фокус снимается сразу: иначе рельс стоял
// разложенным до первого клика мимо. С клавиатуры фокус остаётся.

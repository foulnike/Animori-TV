...
// Наведение живёт на всей плитке, а не на кнопке открытия: иначе переход на крестик читался уходом с плитки.
// Крестик — в левом углу, правка записи — в правом; вместе они не встречаются (витрина против своих списков).

...
//
// Два источника, и это не видно: трейлер даёт AniList, кадры — Шикимори,
// у обоих одна форма. У кого нет страницы встраивания (ютюб, дейлимоушен
// и вимео есть, прочие нет), окно не открывается вовсе — сразу наружу.
// Кадров бывает полсотни: видно шесть, шестая клетка — счётчик остальных
// и вход в галерею. В сетке уменьшенные кадры (~60 КБ), в просмотре
// полный (~1 МБ) и ровно один.

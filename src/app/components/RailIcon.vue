...
// Значки пунктов рельса: нарисованы, а не набраны знаками Юникода — у тех своя величина и толщина из разных шрифтов.
// Правило: вектор в клетке 20×20, одна толщина линии на всех, цвет по тексту (currentColor).
// Исключение — «Обновить»: знак ⟳, свой рисунок дуги со стрелкой трижды выходил неверным и каждый раз по-новому.

...
// Знак сервиса: плита фирменного цвета и вектор из src/app/brand.
//
// Векторы взяты у владельцев, а не нарисованы здесь: прежние самодельные
// пути были заметно кривыми. simple-icons (CC0): anilist, shikimori;
// lucide (ISC): yandex-disk; растр внутри файла: myanimelist, spotify,
// youtube-music, yandex-music — последние три многоцветные, у них
// tint: false и плита не нужна. SVG, а не PNG: знак живёт на 24-28 px,
// на трёх темах и при дробном масштабе окна.

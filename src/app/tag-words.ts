// Русские слова для тэгов и разделов AniList: список перенесён из словаря старого скрипта.
// Неизвестный тэг остаётся собой: английское слово в чипе честнее пропуска. Разделы приходят дефисами — берём последнюю часть.
// Вычитка по канону сообщества, а не по разбору английского.

...
/**
 * Рельс крестика удаления на пульте: крестик сидит поверх строки, и вертикальный обход ловил его на каждом шаге.
 * Слушатель на окне в фазе перехвата: spatial navigation WebView стартует после bubble-фазы keydown.
 * Смотрим на текущий фокус, а не на event.target: реальный пульт ставит target на сфокусированный элемент.
 */

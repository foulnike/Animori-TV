// Подписи ссылок, у которых подписи нет: в BBcode Шикимори тег сущности часто стоит голым ([character=149283]).
// Живёт в надстройке рядом с rich-open.ts: ядру негде взять ни сеть, ни словари подписей.
// Путей три по возрастанию цены, первый бесплатный: люди открытого тайтла уже сопоставлены.

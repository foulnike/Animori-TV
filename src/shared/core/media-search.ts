...
/**
 * Поиск по своему списку: слово сверяется с русским, ромадзи и английским названием.
 * Перед отбором поднимается склад имён, иначе по кириллице нашлось бы только показанное в этом запуске.
 * Взрослое отсеивается наравне с каталогом; спрятанное не занимает места в выдаче, но число его называем словами.
 */

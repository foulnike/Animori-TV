// Метка доступности: есть ли у источников вход к тайтлу — самый дорогой бит в приложении.
// Очередь на видимое, по работнику на источник, склад ответов в mediaCache.
// Срыв — не ответ (заход ужимается, служба отдыхает); молчание — «не знаю», а не «нет».

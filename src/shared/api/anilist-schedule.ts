// Расписание выхода серий своего списка: облика тайтла мало, там одна ближайшая серия.
// Ловушки airingSchedules: это список, а не соединение (nodes не принимается); границы строгие — расширяем окно на секунду.
// Сортировка только по времени, pageInfo.total упирается в 5000: глобальный показ — по верхушке популярного, не по окну.

// Персонажи и авторы тайтла: своим запросом, уже после карточки.
// Состав готового тайтла не меняется, поэтому склад бессрочный: второй взгляд на карточку стоит сети ноль.
// Пустота на склад не ложится: у анонса состава нет сейчас, а через месяц появится.

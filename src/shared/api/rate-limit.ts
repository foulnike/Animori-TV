...
// once() склеивает одинаковые вопросы в пути; темп ведётся по остатку окна из заголовков, а не по потолку.
// Общий шлюз разводит старты: в первые секунды не больше BURST_START_LIMIT в секунду на всё приложение.

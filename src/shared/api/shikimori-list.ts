...
// Входа нет сознательно: открытый профиль отдают любому, OAuth завёл бы лишнюю точку отказа.
// Номера переводим через MAL пачками по пятьдесят; потерянное называем вслух, а не глотаем.

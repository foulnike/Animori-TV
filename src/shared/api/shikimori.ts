...
// Куки не шлём: 'include' однажды дал 400 от размера заголовка. Рабочий адрес переживает перезапуск.
// Зеркала регистрируются пробами в core/net-health: кнопке «Проверить сейчас» адреса знать не нужно.

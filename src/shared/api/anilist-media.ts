...
// Пару номеров спрашиваем последней: память запуска → запись списка → карта выпуска → склад IndexedDB.
// Личную запись не спрашиваем: правда о списке живёт в коллекции, а серверный запас врал.

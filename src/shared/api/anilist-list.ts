...
/**
 * Шкала оценки задана в запросе, а не взята из настроек: иначе запись приходила бы то как 85, то как 8.5.
 * Вид тайтла вписан словом: без условия MediaListCollection отдаёт и аниме, и мангу.
 * Названия, признак взрослого и номер MAL берутся здесь же: отдельный запрос — второй обход коллекции.
 */

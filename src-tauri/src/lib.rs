...
pub fn run() {
    ...
    builder
        ...
        // Родные окна системы: выбор папки для выгрузки списка и для трека темы
        // (export.rs). Дёргается только из Rust, и разрешений разметке не выдано
        // сознательно: dialog:default означал бы право открывать окна выбора файлов
        // без нашего ведома.
